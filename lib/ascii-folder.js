...
class ASCIIFolder {
     ...
     * @param {string} replacement The character an unmapped character should be replaced with or null should the
     * original character be retained
     * @returns {string} The sanitized string
     */
    fold(str, replacement) {
        var foldedStr = String();
        ...
        for (let character of str) {
            if (character.charCodeAt(0) < 128) {
                ...
                foldedStr = foldedStr.concat(this.replaceChar(character, replacement));
            }
        }
    ...
    replaceChar(char, replacement) {
        var ascii = this.mapping.get(char.charCodeAt(0));
